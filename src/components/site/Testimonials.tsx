...
export function Testimonials({ quotes = defaults, eyebrow = "Voices", heading = "What people who've worked with us say." }: { quotes?: Quote[]; eyebrow?: string; heading?: string }) {
  return (
    <section className="py-24 px-6 bg-secondary border-y border-ink/5">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-[40ch] mb-14">
          <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-4">{eyebrow}</div>
          <h2 className="text-3xl md:text-4xl font-medium tracking-tight text-balance">{heading}</h2>
        </div>
