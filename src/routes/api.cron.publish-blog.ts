...
export const APIRoute = createAPIFileRoute("/api/cron/publish-blog")({
    GET: async ({ request }) => {
        // 1. Validate the cron secret header
        // Vercel sends: Authorization: Bearer <CRON_SECRET>
        // Fallback: x-cron-secret header (for manual/Cloudflare triggers)
        ...
        // 2. Create a Supabase service-role client (bypasses RLS)
