  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "OKIKE — Build software. Learn to build it." },
      {
        ...
        content: "Software studio and academy. Build with us, or learn to build it yourself.",
      },
    ],
  }),
  component: HomePage,
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-ink/50">
              {partners.map((p) =>
                p.logo_url ? (
                  ...
                  <span
                    key={p.id}
                    className="text-lg font-semibold tracking-tight hover:text-ink/80 transition"
                  >
                    {p.name}
                  </span>
                ),
      ...
      <section className="py-24 bg-secondary border-y border-ink/5">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12">
          <article className="flex flex-col gap-6">
            ...
            <h2 className="text-3xl font-medium max-w-[22ch] text-balance">
            ...
            <ul className="text-ink/70 divide-y divide-ink/5">
              <li className="py-4 flex justify-between">
                ...
                <span className="text-xs uppercase tracking-wider text-ink/40">Custom build</span>
              </li>
              <li className="py-4 flex justify-between">
                <span>Internal tools & dashboards</span>
                <span className="text-xs uppercase tracking-wider text-ink/40">SaaS</span>
              </li>
              <li className="py-4 flex justify-between">
                <span>MVP launchpad</span>
                <span className="text-xs uppercase tracking-wider text-ink/40">2 weeks</span>
              </li>
            </ul>
            <Link
              to="/services"
              className="inline-flex items-center gap-2 text-brand font-medium mt-2 hover:gap-3 transition-all"
            >
          ...
          <article className="flex flex-col gap-6">
            ...
            <ul className="text-ink/70 divide-y divide-ink/5">
              <li className="py-4 flex justify-between">
                ...
                <span className="text-xs uppercase tracking-wider text-ink/40">12 weeks</span>
              </li>
              <li className="py-4 flex justify-between">
                <span>UI/UX systems design</span>
                <span className="text-xs uppercase tracking-wider text-ink/40">8 weeks</span>
              </li>
              <li className="py-4 flex justify-between">
                <span>One-to-one mentorship</span>
                <span className="text-xs uppercase tracking-wider text-ink/40">Ongoing</span>
              </li>
            </ul>
            <Link
              to="/learn"
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          <div className="max-w-[35ch] text-balance">
            ...
            <p className="text-ink/60 text-pretty">
              ...
              : [
                  {
                    ...
                    price: "From ₦150,000",
                    period: "/ 1 week",
                    desc: "A polished landing page with a contact form and analytics.",
                    cta: "Inquire",
                    highlight: false,
                  },
                  {
                    ...
                    price: "From ₦400,000",
                    period: "/ 2 weeks",
                    desc: "Multi-page marketing site with CMS, forms, and integrations.",
                  ...
                  },
                  {
                    ...
                    price: "Custom Quote",
                    period: "Quote",
                    desc: "Internal tools, dashboards, and SaaS MVPs scoped around your business.",
                    cta: "Contact",
                    highlight: false,
                  },
                ]
      ...
      <section className="py-24 bg-contrast text-contrast-foreground px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="md:w-2/3">
            ...
            <h2 className="text-3xl md:text-4xl font-medium mb-8 max-w-[28ch] text-balance">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8">
          ...
          <p className="text-ink/60 max-w-[48ch] text-pretty">
            Whether you need a partner to ship your next product or a path to becoming the engineer
            behind it — OKIKE is built for both.
          </p>
...
function PricingCard({
  ...
  return (
    <div
      className={`p-8 bg-surface rounded-2xl flex flex-col gap-6 relative overflow-hidden ${highlight ? "ring-1 ring-brand/30" : "ring-1 ring-ink/5"}`}
    >
      {highlight && (
      ...
      <Link
        to="/book"
        className={`w-full py-3 rounded-full text-sm font-medium text-center transition ${highlight ? "bg-brand text-brand-foreground ring-1 ring-brand hover:opacity-90" : "bg-contrast text-contrast-foreground hover:bg-ink/90"}`}
      >
        {cta}
      </Link>
    </div>
