...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "OKIKE designs and builds scalable platforms, AI tools, mobile apps and student-focused digital systems for startups, creators and organizations." },
      { property: "og:title", content: "Services — OKIKE" },
      { property: "og:description", content: "Scalable platforms, AI tools, mobile apps and modern digital experiences — engineered by OKIKE." },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          provider: { "@type": "Organization", name: "OKIKE", url: "https://okike-enterprise.lovable.app" },
          name: "OKIKE software, AI & product services",
          description: "AI automation, web & mobile platforms, UI/UX design, student & campus systems, and branding for ambitious teams.",
...
const coreServices = [
  {
    icon: Bot,
    title: "AI & Automation",
    blurb: "Automate repetitive tasks and build intelligent systems that think alongside your team.",
    bullets: ["AI chatbots & assistants", "Workflow automation", "AI integrations (OpenAI, Gemini)", "Business process automation"],
  },
  {
    icon: Code2,
    title: "Web Application Development",
    blurb: "Scalable, secure, modern web platforms — built with the stack the best teams ship on.",
    bullets: ["SaaS platforms", "Dashboards & admin panels", "Custom portals & APIs", "React · Next.js · Cloudflare"],
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    bullets: ["Student portals", "Complaint & feedback systems", "Material repositories", "Course & GPA checkers"],
  },
  {
    icon: Sparkles,
    title: "Branding & Digital Presence",
    blurb: "Build a strong identity and a digital presence that actually stands out.",
    bullets: ["Startup identity", "Modern marketing sites", "Portfolio websites", "Founder & personal brands"],
  },
];

const process = [
  { n: "01", icon: Search, t: "Discovery", d: "We understand your vision, users and constraints before writing a single line of code." },
  { n: "02", icon: Compass, t: "Strategy", d: "We plan the architecture, flows and user experience — you approve every screen." },
  { n: "03", icon: Hammer, t: "Development", d: "We build scalable systems with daily progress and weekly demos." },
  { n: "04", icon: Rocket, t: "Launch & Support", d: "We deploy, optimize and maintain so your product keeps growing after day one." },
];
...
const stack = ["Next.js", "React", "Node.js", "TypeScript", "PostgreSQL", "Tailwind CSS", "Python", "Firebase", "Cloudflare", "OpenAI"];
...
const faqs = [
  { q: "How long does development take?", a: "Most engagements ship in 2–8 weeks. MVPs typically take 4–6 weeks; marketing sites 1–3 weeks; custom platforms can run longer. We commit to a fixed timeline before we start." },
  { q: "Do you work internationally?", a: "Yes. We work with founders, startups and organizations across Africa, Europe and North America — fully remote, async-friendly, with weekly check-ins." },
  { q: "Can you redesign or rebuild existing systems?", a: "Absolutely. A large part of our work is taking outdated or fragile products and rebuilding them with modern architecture, better UX and a real foundation for scale." },
  { q: "Do you provide maintenance after launch?", a: "Yes. Every project includes 30 days of post-launch support, and you can continue on a retainer for ongoing engineering, monitoring and improvements." },
  { q: "Can you build AI-powered systems?", a: "Yes — this is one of our specialties. We build chatbots, AI assistants, document workflows, smart search and custom integrations with OpenAI, Gemini and your own data." },
];
  ...
  return (
    <SiteLayout>
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24 grid lg:grid-cols-[1.05fr_1fr] gap-12 lg:gap-10 items-center">
          <div className="flex flex-col gap-8">
            ...
            <p className="text-lg text-ink/65 max-w-[54ch] text-pretty">
              We design and develop scalable platforms, AI-powered tools and modern digital experiences for startups, creators and organizations — built with the rigor of a studio and the speed of a startup.
            </p>

            <div className="flex flex-wrap gap-3 pt-2">
              <Link to="/book" className="group bg-brand text-brand-foreground py-3.5 pl-6 pr-5 inline-flex items-center gap-2 rounded-full font-medium shadow-sm hover:opacity-90 transition">
                Start a project
                <ArrowUpRight className="size-4 transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
              </Link>
              <a href="#work" className="group bg-ink/[0.04] text-ink py-3.5 pl-6 pr-5 inline-flex items-center gap-2 rounded-full font-medium ring-1 ring-ink/10 hover:bg-ink/[0.07] transition">
                View our work
          ...
          <div className="relative">
            ...
            <div className="relative rounded-2xl overflow-hidden ring-1 ring-ink/10 shadow-[0_30px_80px_-30px_rgba(146,64,14,0.35)] bg-card">
              <img src={heroDashboard} alt="OKIKE product dashboard preview" width={1536} height={1152} className="w-full h-auto object-cover" />
            </div>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center gap-4 mb-16">
            <div className="text-xs font-semibold tracking-widest uppercase text-brand">What we do</div>
            <h2 className="text-3xl md:text-5xl font-medium tracking-tight max-w-[22ch] text-balance">Our core services.</h2>
            <p className="text-ink/60 max-w-[52ch] text-pretty">End-to-end digital solutions tailored to your goals — from a single landing page to a full AI-powered platform.</p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {coreServices.map(({ icon: Icon, title, blurb, bullets }) => (
              <div key={title} className="group p-8 bg-card rounded-2xl ring-1 ring-ink/5 flex flex-col gap-5 hover:ring-brand/30 hover:-translate-y-1 transition-all">
      ...
      <section className="py-24 bg-secondary border-y border-ink/5 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-[42ch] mb-16">
            <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-4">Our process</div>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight">A simple, transparent and collaborative way of working.</h2>
          </div>
      ...
      <section id="work" className="py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-3">Featured results</div>
              <h2 className="text-3xl md:text-4xl font-medium tracking-tight max-w-[24ch] text-balance">Real systems. Real impact.</h2>
            </div>
            <p className="text-ink/60 max-w-[40ch]">A few outcomes from products we&apos;ve shipped for students, founders and organizations.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {results.map((r) => (
              <div key={r.label} className="p-8 bg-card rounded-2xl ring-1 ring-ink/5 flex flex-col gap-4">
      ...
      <section className="py-24 bg-contrast text-contrast-foreground px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center gap-10">
          <div className="flex flex-col gap-4 items-center">
            ...
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight max-w-[28ch] text-balance">Built on the stack the best teams ship on.</h2>
          </div>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-[42ch] mb-16">
            <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-4">Who we help</div>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight">Built for the people building what&apos;s next.</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {industries.map((i) => (
              <div key={i.t} className="p-6 rounded-2xl ring-1 ring-ink/5 bg-card hover:ring-brand/30 transition">
      ...
      <section className="py-24 bg-secondary border-y border-ink/5 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-[42ch] mb-16">
            <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-4">How we engage</div>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight">Flexible engagement models.</h2>
            <p className="text-ink/60 mt-4">Pick the partnership that fits your stage. We&apos;ll send a detailed quote within 24 hours of your inquiry.</p>
          </div>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-3">Frequently asked</div>
            <h2 className="text-3xl md:text-4xl font-medium tracking-tight">Questions, answered.</h2>
          </div>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-8">
          <h2 className="text-4xl md:text-6xl font-medium tracking-tight text-balance">
            Let&apos;s build something <span className="text-brand italic font-medium">meaningful</span>.
          </h2>
...
function PortfolioGrid() {
  ...
  return (
    <div className="mt-8 pt-16 border-t border-ink/5">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          <div className="text-xs font-semibold tracking-widest uppercase text-brand mb-3">Selected work</div>
          <h3 className="text-3xl md:text-4xl font-medium tracking-tight max-w-[24ch] text-balance">Projects we&apos;ve shipped.</h3>
        </div>
      </div>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((item) => {
                ...
                {item.tags?.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-auto pt-2">
                    {item.tags.slice(0, 4).map((t) => (
                      <span key={t} className="text-[10px] uppercase tracking-wider px-2 py-1 rounded-full bg-ink/5 text-ink/60">{t}</span>
                    ))}
                  </div>
                )}
              </div>
...
function FaqItem({ q, a, defaultOpen = false }: { q: string; a: string; defaultOpen?: boolean }) {
  ...
  return (
    <div className="py-5">
      <button onClick={() => setOpen((o) => !o)} className="w-full flex items-center justify-between gap-6 text-left group">
        <span className="text-lg font-medium text-ink group-hover:text-brand transition">{q}</span>
        <span className={`inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-brand/10 text-brand transition-transform ${open ? "rotate-45" : ""}`}>
